...
<footer class="bg-gray-800" aria-labelledby="footerHeading">
    ...
    <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
      <div class="pb-8 xl:grid xl:grid-cols-5 xl:gap-8 flex-footer">
        <div class="grid grid-cols-2 gap-8 xl:col-span-4 flex-footer flex-70">
          <div class="md:grid md:grid-cols-2 md:gap-8 flex-footer flex-50">
            <div>
        ...
        <div class="mt-12 xl:mt-0 flex-30">
          <h3 class="text-sm font-semibold text-gray-400 tracking-wider uppercase">
            Language &amp; Currency
          </h3>
